...
/home/hitra/fullPotentialSolver/bin/main -f /home/hitra/fullPotentialSolver/input_file/input_file_fps_2049_alpha_1-5_mach_0-1.txt -nl 1 > /scratch/hitra/output_fps_2049_alpha_1-5_mach_0-1.txt