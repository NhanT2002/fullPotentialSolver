...
/home/hitra/fullPotentialSolver/bin/main -f /home/hitra/fullPotentialSolver/input_file/input_file_fps_2048_alpha_0-0_mach_0-1_cylinder.txt -nl 1 > /scratch/hitra/output_scale_res/output_scale_res_fps_2048_alpha_0-0_mach_0-1_cylinder.txt