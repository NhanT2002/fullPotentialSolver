...
class unsteadySpatialDiscretization {
    ...
    var wake_face_dom_real: domain(1) = {1..0};
    var wakeFaceRealX_: [wake_face_dom_real] real(64);
    var wakeFaceRealY_: [wake_face_dom_real] real(64);
    var wakeFaceRealZ_: [wake_face_dom_real] real(64);
    var wakeFaceRealGamma_: [wake_face_dom_real] real(64);
    ...
    proc rho(u: real(64), v: real(64), phi_t: real(64)): real(64) {
        return (1 + this.gamma_minus_one_over_two_ * this.inputs_.MACH_**2 * (1 - u**2 - v**2)) ** this.one_over_gamma_minus_one_;
    }
